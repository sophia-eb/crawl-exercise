...
class WeiboPersonalInfoSpider:
    ...
    def crawl_weibo(self, user_id, container_id):
        ...
        while True:
            ...
            # 可以修改self.weibo_total_number为一个具体的数字，减少遍历重复数据
            ...
            for card_number in range(len(cards)):
                ...
                # print(card_detail)
                time.sleep(3)
                self.insert_into_weibo_details_db(card_detail)

            print("++++++++++++++++++++++++++")
            page_number += 1

    def insert_into_weibo_details_db(self, card_detail):
        print("========= insert into db =========")

        sql = """
        INSERT INTO `weibo_details` (`user_id`, `item_id`, `scheme`, `source`, `region_name`, `reposts_count`, `comments_count`, `attitudes_count`, `text`, `image_content`, `large_image_url`, `weibo_created_at`, `created_date`) values ('{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}');
        """ .format(
            card_detail["user_id"],
            card_detail["item_id"],
            card_detail["scheme"],
        ...
        try:
            ...
            # 提交，不然无法保存新建或者修改的数据
            self.db.commit()
            print(self.cursor.rowcount, "record inserted. Go! Go! Go!")
        except Exception as e:
            print("插入数据库异常！！！")
            print("Error: ", e)
            self.db.rollback()
...
if __name__ == '__main__':
    ...
    # 王俊凯，王源，易烊千玺，
    # 蒲熠星，文韬，齐思钧，周峻纬，唐九洲，何运晨，曹恩齐，石凯，
    # 肖战，王一博，龚俊，胡歌，张子枫
    # userid_list = [2609400635, 2812335943, 3623353053,
    #                2882733894, 3962982466, 1808764472, 6203188939,
    #                2620811727, 3925308009, 5080118124, 5985666104,
    #                1792951112, 5492443184, 2172061270,
    #                1223178222, 1353112775]
    userid_list = [1792951112]
